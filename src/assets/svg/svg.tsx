...
export const HomeBlankSVG = ({ ...props }) => (
  <svg {...props} role="img" viewBox="0 0 24 24">
    <path
...
export const ActiveMessengerSVG = ({ ...props }) => (
  <svg {...props} role="img" viewBox="0 0 24 24">
...
export const ActiveExploreSVG = ({ ...props }) => (
  <svg {...props} role="img" viewBox="0 0 24 24">
...
export const SwitchAccountSVG = ({ ...props }) => (
  <svg {...props} role="img" viewBox="0 0 24 24">
...
export const FeedMenuSVG = ({ ...props }) => (
  <svg {...props} role="img" viewBox="0 0 24 24">
...
export const ActiveLikeSVG = ({ ...props }) => (
...
export const SharePostSVG = ({ ...props }) => (
  <svg {...props} role="img" viewBox="0 0 24 24">
    <line
      fill="none"
      stroke="currentColor"
...
export const ActiveAddPostSVG = ({ ...props }) => (
  <svg {...props} role="img" viewBox="0 0 24 24">
...
export const MediaSVG = ({ ...props }) => (
  <svg {...props} role="img" viewBox="0 0 97.6 77.3">
    <path
